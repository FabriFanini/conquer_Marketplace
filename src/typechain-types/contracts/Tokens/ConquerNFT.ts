...
export interface ConquerNFTInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "approve"
      | "balanceOf"
...
export interface ConquerNFT extends BaseContract {
  connect(runner?: ContractRunner | null): ConquerNFT;
  waitForDeployment(): Promise<this>;

  interface: ConquerNFTInterface;
